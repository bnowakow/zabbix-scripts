...
python2 zabbix.template.export.py --url http://192.168.0.20:18080 --user='Admin' --password="$(cat .password)" --template='All'
python2 zabbix.template.export.py --url http://192.168.0.20:18080 --user='Admin' --password="$(cat .password)" --template='All' --type='host' --out-dir='hosts'
